...
impl<'o> TracebackSequenceIterator<'o, 'o> {
    ...
    fn new_inner(
        ...
        let end_cursor = parent.search_site(ancestor, end);
        ...
        if matches!(
            ...
            let event = &parent.marginal_tree.linked_viterbi_events[end_cursor];
    ...
    fn search_site(&self, ancestor: Ancestor, site: VariantIndex) -> usize {
