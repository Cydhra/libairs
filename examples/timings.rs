...
enum Action {
    ...
    MatchAncestors {
        ...
        /// How many ancestors should run per thread before resynchronizing the tree sequence. Defaults to 4.
...
fn main() {
    ...
    println!("running with {} threads", args.num_threads);
    if args.num_threads > 1 {
        println!("setting global thread pool...");
    ...
    match args.command {
        ...
        Action::MatchAncestors {
            ...
            let mut ancestor_matcher = ViterbiMatcher::with_parallelism(
                ancestor_array,
                1e-2,
                1e-20,
                true,
